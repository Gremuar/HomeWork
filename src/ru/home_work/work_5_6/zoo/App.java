package ru.home_work.work_5_6.zoo;


import ru.home_work.work_5_6.zoo.animal.*;
...
Домашняя работа №5:
    ...
    Методы,которые являются различными для всех животных,вынести в интерфейсы.(например,Moveable и т.д)
    ...
    Добавить пакет исключений для зоопарка(com.zoo.exception),создать два типа(класса)проверяемых исключений.
...
public class App {
    public static void main(String[] args) throws AviaryOverflowException, AviaryDuplicateAnimalException {
